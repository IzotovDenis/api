...
ActiveRecord::Schema.define(version: 20170427044744) do
  ...
  create_table "auth_tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["val"], name: "index_auth_tokens_on_val", using: :btree
  end
  ...
  create_table "currencies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["val"], name: "index_currencies_on_val", using: :btree
  end
